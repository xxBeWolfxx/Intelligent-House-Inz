...
data class  ESPO(var id: String, var name: String, var pin: Int, var status: Boolean, var description: String, var sensor: Int?, var minValue: Int?, var maxValue: Int?, var currentValue: Int?):Serializable {
